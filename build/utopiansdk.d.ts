export declare namespace UtopianSDK {
     ...
     * @returns Promise object array of posts
     */
    function getPendingPostsByModeratorAndCategory(moderator: string, category: string, options: Options): Promise<Array<Post>>;
    /**
     ...
     */
    function getPendingPostsByCategory(category: string, options: Options): Promise<number>;
    /**
     * @method: Return count of pending posts by a given query
     * @argument {Options} options: query for the posts
     * @returns Promise type number
     */
    function getPendingPosts(options: Options): Promise<number>;
    /**
     * @method: Return list of the pending posts of the given moderator
     * @argument {string} moderator: moderator to query
     * @returns Promise object array of posts
     */
    function getPendingPostsByModerator(moderator: string): Promise<Posts>;
    /**
     * @method: Return count of all pending posts
     * @returns Promise type number
     */
    function getPendingPostsCount(): Promise<number>;
    /**
     * @method: Return count of all posts
     * @returns Promise type number
     */
    function getTotalPostCount(): Promise<number>;
    /**
     * INTERFACES AREA
     */
    interface Posts {
    ...
    interface Sponsor extends Moderator {
